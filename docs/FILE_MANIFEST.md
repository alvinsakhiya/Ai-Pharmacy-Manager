...
| `docs/` | docs | Project documentation: backup/restore guide, catalogue and TRUD dm+d import guides, demo evidence/script, phase 1 & 2 acceptance criteria. | Developers, graders/examiners, operators | — | — | — | Keep | Academic evidence and operational guides; not shipped at runtime but load-bearing for the project deliverable. |
